package com.meusim.application.modules.identify.user.dto;
...
class CreateUserRequestDTOTest {
    ...
    private Set<ConstraintViolation<CreateUserRequestDTO>> validate(
            String u, String e, String p, String c, String ph, String ad
    ) {
        return validator.validate(new CreateUserRequestDTO(u, e, p, c, ph, ad));
    }

    private void assertNoViolations(Set<ConstraintViolation<CreateUserRequestDTO>> violations) {
    ...
    final class DadosValidos {
        ...
        void shouldConvertEmailToLowercase() {
            CreateUserRequestDTO request = new CreateUserRequestDTO(username, "JOAO@EMAIL.COM", password, cpf, phoneNumber, address);
