package com.meusim.application.modules.licensing.schoolsubscription.controller;
...
public class SchoolSubscriptionController {
    ...
    public SchoolSubscriptionController(SchoolSubscriptionService schoolSubscriptionService) {
        this.schoolSubscriptionService = schoolSubscriptionService;
    }

    @GetMapping
    @PreAuthorize("hasAuthority('SCOPE_school_admin')")
    public ResponseEntity<PageResponse<SchoolSubscriptionResponse>> pageBySchool(
