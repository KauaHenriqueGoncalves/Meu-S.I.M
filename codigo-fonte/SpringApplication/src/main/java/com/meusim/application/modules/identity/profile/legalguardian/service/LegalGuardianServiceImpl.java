package com.meusim.application.modules.identity.profile.legalguardian.service;

import com.fasterxml.jackson.core.type.TypeReference;
import com.meusim.application.modules.academic.student.dto.StudentResponse;
import com.meusim.application.modules.academic.student.service.StudentQuery;
...
import com.meusim.application.modules.identity.profile.legalguardian.dto.LegalGuardianResponse;
...
import com.meusim.application.modules.identity.base.user.cache.UserCacheKeys;
...
public class LegalGuardianServiceImpl implements LegalGuardianService {
    ...
    @Override
    @Transactional
    public LegalGuardian save(UUID userId, CreateUserRequestDTO createUserRequestDTO, LegalGuardianRequest legalGuardianRequest) {
        School school = schoolService.findByUserId(userId);

        log.info("Iniciando cadastro de responsável. [requisitanteId={}] [schoolId={}] [email={}]",
                userId, school.getId(), createUserRequestDTO.email());

        ensureSubscriptionSupportsLegalGuardianCount(school.getId());

        User user = userService.registerUserWithRole(createUserRequestDTO, Role.Values.LEGAL_GUARDIAN);
