...
import com.system.application.modules.identity.profile.systemadmin.cache.SystemAdminCacheKeys;
import com.system.application.modules.identity.profile.systemadmin.dto.UpdateSystemAdminRequestDTO;
import com.system.application.modules.identity.profile.systemadmin.repository.SystemAdminRepository;
import com.system.application.modules.identity.profile.systemadmin.validator.SystemAdminValidator;
...
public class SystemAdminServiceImpl implements SystemAdminService {
    ...
    @Override
    @Transactional
    public SystemAdmin create(CreateUserRequestDTO dto) {
        UUID ownerId = authenticatedUserService.getOwnerId();
        log.info("Criando um administrador do sistema. [ownerId={}]", ownerId);
        User user = userService.registerUserWithRole(dto, Role.Values.SYSTEM_ADMIN);
