package com.system.application.core.schoolplan.controller;
...
public class SchoolPlanController {
    ...
    public ResponseEntity<List<SchoolPlanSimpleResponse>> findAllSimple() {
        List<SchoolPlanSimpleResponse> schoolPlans =
                schoolPlanService.findAllSimple();
        return ResponseEntity.ok(schoolPlans);
    }
