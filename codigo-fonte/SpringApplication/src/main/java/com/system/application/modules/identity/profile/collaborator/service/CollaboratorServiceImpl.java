package com.system.application.modules.identity.profile.collaborator.service;
...
import com.system.application.modules.identity.profile.collaborator.dto.CollaboratorResponse;
...
import com.system.application.modules.identity.base.user.cache.UserCacheKeys;
...
public class CollaboratorServiceImpl implements CollaboratorService {
    ...
    @Override
    @Transactional
    public Collaborator save(UUID userId, CreateUserRequestDTO createUserRequestDTO, CollaboratorRequest collaboratorRequest) {
        School school = schoolService.findByUserId(userId);
        ...
        User user = userService.registerUserWithRole(createUserRequestDTO, Role.Values.COLLABORATOR);
